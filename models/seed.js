...
mongoose.connection.on("open", () => { //if open and connect to db run this function
  ...
  const starterRecipes = [
    { name: "Apple Pie",img:"https://media.istockphoto.com/id/119689299/photo/foot.jpg?s=612x612&w=0&k=20&c=9JOAymP36fEIznaAM7XXw_EYqZWXa5djEUf3-zqSoZI=", ingredients: "salt", directions: "add 1/2 cup of water", notes:"This was fun!", user:'63936d65813d6609a9d0a44b'},
